<!-- Task: View Doctor Information - in ascending order of last name -->
<!-- Programmer: Rena Li -->
<!-- Date: Nov 25, 2022 -->
...
<h1>List of Doctors by Last Name (in Ascending Order)</h1>
...
<br>
<?php
/* Uses query to display doctor information from database based on selected ordering of lastname ascending */
...
<script>
/* Javascript functions to redirect user to new page depending on selection (asc order - stays on this page, desc - new page, main page) */
function displayAsc(){
