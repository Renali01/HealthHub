<!-- Task: View Doctor Information - in descending order of last name-->
<!-- Programmer: 08 -->
<!-- Date: Nov 25 -->
...
<h1>List of Doctors by Last Name (in Descending Order)</h1>
...
<br>
<?php
/* Uses query to display doctor information from database based on selected ordering of lastname descending */
...
<script>
/* Javascript functions to redirect user to new page depending on selection (asc order - new page, desc - stay on this page, main page) */
function displayAsc(){
        window.location="lastname.php";
}
function displayDesc(){
        window.location="lastnameDesc.php";
}
