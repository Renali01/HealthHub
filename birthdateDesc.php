<!-- Task: View Doctor Information - in descending order of birthdate-->
<!-- Programmer: 08 -->
<!-- Date: Nov 25 -->
...
<h1>List of Doctors by Birth Date (in Descending Order)</h1>
...
<br>
<?php
/* Uses query to display doctor information from database based on selected ordering of birth date descending */
...
<script>
/* Javascript functions to redirect user to new page depending on selection (asc order - new page, desc - same page, main page) */
function displayAsc(){
